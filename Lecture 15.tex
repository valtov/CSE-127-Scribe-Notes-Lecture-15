...
\includegraphics[scale=1]{./DiffieStep3.png}
...
\includegraphics[scale=1]{./DiffieStep4.png}
...
Step 5 of TLS 1.2 with a Diffie-Hellman Key Exchange is  

\includegraphics[scale=1.2]{./DiffieStep5.png}

\newpage
\subsubsection{Step 6}
Step 6 of TLS 1.2 with a Diffie-Hellman Key Exchange is 

\includegraphics[scale=1.2]{./DiffieStep6.png}

\newpage
\subsubsection{Step 7}
Step 7 of TLS 1.2 with a Diffie-Hellman Key Exchange is 

\includegraphics[scale=1.2]{./DiffieStep7.png}

\newpage
\subsubsection{Step 8}
Step 8 of TLS 1.2 with a Diffie-Hellman Key Exchange is 
